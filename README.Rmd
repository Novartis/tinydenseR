...
* [Quick Start](https://opensource.nibr.com/tinydenseR/articles/quick-start.html)
...
`tinydenseR` requires R (>= 4.1) and Bioconductor and CRAN packages. Most dependencies will be installed automatically, but you may need to install some of them manually, like `BPCells`:
