...
Above we identified differential cell states within cluster 4. Let's use `get.markerDE()` to identify which markers define this cluster compared to all other cells:
