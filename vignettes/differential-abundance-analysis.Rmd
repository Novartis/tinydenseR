...
Above we identified differential cell states within cluster 4. Let's use `get.marker()` to identify which markers define this cluster compared to all other cells:

```{r marker-identification}
# Identify markers for cluster 4
.marker.0.5 <-
