...
Our simulation worked: we see approximately 2-fold depletion (log2FC ≈ -1) from baseline abundance.
...
While differential abundance analysis reveals which populations change in proportion, we can also examine the **marker expression profiles** that define these populations. This helps us understand the biological identity of the affected cell types.
