...
Importanly, tinydenseR **does not depened** on clustering for differential expression. As a matter of fact, any cell state feature can be used to define the target population as shown further below.
...
# View coefficients
.dea.0.5$coefficients["Marker2",]
```

```{r dea-results-pvalues}
# View adjusted p-values
.dea.0.5$adj.p["Marker2",]
```
